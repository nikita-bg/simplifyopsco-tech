...
export function ChatWidget() {
    ...
    // Hide on dashboard pages (sidebar has its own nav)
        ...
        <>
            ...
            <div
                className={`fixed z-50 overflow-hidden transition-all duration-300
                    ...
                    bottom-24 left-3 right-3 sm:left-6 sm:right-auto
                    /* Desktop: fixed width */
                    sm:w-[380px]
                    rounded-2xl
                    origin-bottom-left ${isOpen
                        ? "scale-100 opacity-100 translate-y-0"
                        : "scale-95 opacity-0 translate-y-4 pointer-events-none"
                    }`}
            >
                {/* Solid dark background for mobile, glass on desktop */}
                <div className="bg-[#1a1d24] sm:bg-[#1a1d24]/95 sm:backdrop-blur-xl border border-white/10 shadow-2xl flex flex-col h-[min(560px,70vh)] rounded-2xl">
                    {/* Header */}
                    <div className="flex items-center justify-between px-4 sm:px-5 py-4 border-b border-white/10">
                        <div className="flex items-center gap-3">
                            <div className="relative">
                                ...
                                <div className="absolute -bottom-0.5 -right-0.5 h-3.5 w-3.5 rounded-full border-2 border-[#1a1d24] bg-green-400" />
                            </div>
                            <div>
                    ...
                    <form
                        ...
                        className="px-3 sm:px-4 py-3 border-t border-white/10 flex items-center gap-2"
                    >
                        <input
                            ref={inputRef}
                            value={input}
