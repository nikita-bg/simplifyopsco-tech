...
export function Footer() {
    return (
        <footer className="border-t border-slate-200 dark:border-white/10 bg-background-light dark:bg-background-dark pt-16 pb-8">
            <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
                    ...
                    <div className="col-span-2 lg:col-span-2">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm max-w-xs mb-6">
                            Making the web conversational, one website at a time. The first
                            AI-powered voice interface for modern web applications.
                        </p>
                ...
                <div className="border-t border-slate-200 dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-xs text-slate-500 dark:text-slate-500">
                        © 2026 Vocalize AI Inc. All rights reserved.
                    </p>
