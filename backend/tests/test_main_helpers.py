...
class TestTimeAgo:
    ...
    def test_one_minute(self):
        result = _time_ago(datetime.utcnow() - timedelta(minutes=1, seconds=5))
    ...
    def test_one_hour(self):
        result = _time_ago(datetime.utcnow() - timedelta(hours=1, minutes=5))
    ...
    def test_one_day(self):
        result = _time_ago(datetime.utcnow() - timedelta(days=1, hours=1))
