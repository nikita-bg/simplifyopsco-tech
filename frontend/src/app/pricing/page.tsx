...
export default function PricingPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center py-24 px-6 bg-canvas text-heading">
            <div className="absolute top-6 left-6">
                <Link href="/" className="flex items-center gap-2 text-muted hover:text-heading transition-colors text-sm">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 text-xs font-medium text-primary mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl w-full">
                <PricingCard
                    ...
                    features={["100 minutes/month", "500 products", "Standard voice", "Basic analytics", "Email support", "$0.45/min overage"]}
                    cta="Get Started"
                    highlighted={false}
                />
                <PricingCard
                    ...
                    features={["300 minutes/month", "5,000 products", "Custom brand voice", "Full analytics + transcripts", "Priority support", "$0.35/min overage"]}
                ...
                <PricingCard
                    ...
                    features={["1,000 minutes/month", "Unlimited products", "Multilingual voice", "Full analytics + custom reports", "Dedicated support", "$0.25/min overage"]}
                    cta="Get Started"
                    highlighted={false}
                />
            </div>
...
function PricingCard({ title, price, plan, storeId, isLoggedIn, desc, features, cta, highlighted }: {
    ...
    return (
        <div className={`p-8 rounded-2xl flex flex-col transition-all ${highlighted
                ? "bg-panel border-2 border-primary shadow-[0_0_40px_oklch(52%_0.22_260/0.15)] scale-105"
                : "bg-panel border border-white/5 hover:border-white/20"
            }`}>
            {highlighted && (
                <div className="text-xs font-bold text-primary-400 mb-4 uppercase tracking-wider">Most Popular</div>
            )}
            ...
            <p className="text-faint text-sm mb-8">{desc}</p>
            ...
            <button
                ...
                className={`w-full py-3 rounded-lg font-semibold text-sm transition-all cursor-pointer disabled:opacity-50 ${highlighted
                    ...
                    : "bg-white/5 hover:bg-white/10 border border-edge"
                }`}
            >
